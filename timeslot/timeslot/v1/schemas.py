...
validators = {
    ...
    ('bookings', 'GET'): {'args': {'required': [], 'properties': {'dentistName': {'description': 'Name of dentist', 'required': False, 'type': 'string'}, 'patientName': {'description': 'Name of Patient', 'required': False, 'type': 'string'}, 'time': {'description': 'Time of Booking', 'required': False, 'type': 'string'}}}},
}
